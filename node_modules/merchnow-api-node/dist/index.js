...
var BASEURL = "https://merchnow.com/catalogs/showList?";
/**
 ...
 */
exports.getCatalog = function (string, offset) {
    if (offset === void 0) { offset = 0; }
    return __awaiter(void 0, void 0, void 0, function () {
        var response, Content, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    response = _a.sent();
                    Content = htmlParser_1.catalogToObject(response.Content);
                    return [2 /*return*/, __assign(__assign({}, response), { Content: Content })];
                case 3:
                    err_1 = _a.sent();
                    if (err_1) {
